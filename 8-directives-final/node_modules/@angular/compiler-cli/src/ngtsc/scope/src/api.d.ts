...
import { Reexport, Reference } from '@angular/compiler-cli/src/ngtsc/imports';
import { DirectiveMeta, NgModuleMeta, PipeMeta } from '@angular/compiler-cli/src/ngtsc/metadata';
