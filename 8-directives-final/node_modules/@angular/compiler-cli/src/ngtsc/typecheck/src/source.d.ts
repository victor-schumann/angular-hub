...
import { TemplateId, TemplateSourceMapping } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
import { TemplateSourceResolver } from '@angular/compiler-cli/src/ngtsc/typecheck/src/tcb_util';
/**
