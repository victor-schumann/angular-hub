...
import { ComponentScopeReader, TypeCheckScopeRegistry } from '@angular/compiler-cli/src/ngtsc/scope';
import { DirectiveInScope, ElementSymbol, FullTemplateMapping, GlobalCompletion, NgTemplateDiagnostic, OptimizeFor, PipeInScope, ProgramTypeCheckAdapter, TcbLocation, TemplateSymbol, TemplateTypeChecker, TypeCheckableDirectiveMeta, TypeCheckingConfig } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
import { ShimTypeCheckingData } from '@angular/compiler-cli/src/ngtsc/typecheck/src/context';
