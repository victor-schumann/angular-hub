...
import { FullTemplateMapping, NgTemplateDiagnostic, TypeCheckableDirectiveMeta } from '@angular/compiler-cli/src/ngtsc/typecheck/api/api';
import { GlobalCompletion } from '@angular/compiler-cli/src/ngtsc/typecheck/api/completion';
import { DirectiveInScope, PipeInScope } from '@angular/compiler-cli/src/ngtsc/typecheck/api/scope';
import { ElementSymbol, Symbol, TcbLocation, TemplateSymbol } from '@angular/compiler-cli/src/ngtsc/typecheck/api/symbols';
/**
