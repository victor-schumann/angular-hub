...
import { ShimAdapter, ShimReferenceTagger } from '@angular/compiler-cli/src/ngtsc/shims';
import { FactoryTracker } from '@angular/compiler-cli/src/ngtsc/shims/api';
import { RequiredDelegations } from '@angular/compiler-cli/src/ngtsc/util/src/typescript';
import { ExtendedTsCompilerHost, NgCompilerAdapter, NgCompilerOptions, UnifiedModulesHost } from '@angular/compiler-cli/src/ngtsc/core/api';
/**
...
export declare class DelegatingCompilerHost implements Omit<RequiredDelegations<ExtendedTsCompilerHost>, 'getSourceFile' | 'fileExists'> {
    ...
    transformResource: ((data: string, context: import("@angular/compiler-cli/src/ngtsc/core/api").ResourceHostContext) => Promise<import("@angular/compiler-cli/src/ngtsc/core/api").TransformResourceResult | null>) | undefined;
