...
import { SymbolWithValueDeclaration } from '@angular/compiler-cli/src/ngtsc/util/src/typescript';
import { DirectiveInScope } from '@angular/compiler-cli/src/ngtsc/typecheck/api/scope';
