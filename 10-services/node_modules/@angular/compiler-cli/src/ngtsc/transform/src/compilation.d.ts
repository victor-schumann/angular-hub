...
import { SourceFileTypeIdentifier } from '@angular/compiler-cli/src/ngtsc/core/api';
import { IncrementalBuild } from '@angular/compiler-cli/src/ngtsc/incremental/api';
...
import { ClassDeclaration, DeclarationNode, Decorator, ReflectionHost } from '@angular/compiler-cli/src/ngtsc/reflection';
import { ProgramTypeCheckAdapter, TypeCheckContext } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
import { ExtendedTemplateChecker } from '@angular/compiler-cli/src/ngtsc/typecheck/extended/api';
import { Xi18nContext } from '@angular/compiler-cli/src/ngtsc/xi18n';
import { CompilationMode, CompileResult, DecoratorHandler, HandlerFlags } from '@angular/compiler-cli/src/ngtsc/transform/src/api';
import { DtsTransformRegistry } from '@angular/compiler-cli/src/ngtsc/transform/src/declaration';
import { PendingTrait, Trait } from '@angular/compiler-cli/src/ngtsc/transform/src/trait';
/**
