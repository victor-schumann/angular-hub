...
import { AstFactory } from '@angular/compiler-cli/src/ngtsc/translator/src/api/ast_factory';
import { ImportGenerator } from '@angular/compiler-cli/src/ngtsc/translator/src/api/import_generator';
import { Context } from '@angular/compiler-cli/src/ngtsc/translator/src/context';
