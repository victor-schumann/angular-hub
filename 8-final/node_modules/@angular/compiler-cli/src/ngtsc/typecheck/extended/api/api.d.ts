...
import { ErrorCode, ExtendedTemplateDiagnosticName } from '@angular/compiler-cli/src/ngtsc/diagnostics';
import { NgTemplateDiagnostic, TemplateTypeChecker } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
/**
