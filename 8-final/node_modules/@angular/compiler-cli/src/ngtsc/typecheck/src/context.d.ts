...
import { TemplateDiagnostic, TemplateId, TemplateSourceMapping, TypeCheckableDirectiveMeta, TypeCheckContext, TypeCheckingConfig, TypeCtorMetadata } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
import { DomSchemaChecker } from '@angular/compiler-cli/src/ngtsc/typecheck/src/dom';
...
import { TypeCheckFile } from '@angular/compiler-cli/src/ngtsc/typecheck/src/type_check_file';
