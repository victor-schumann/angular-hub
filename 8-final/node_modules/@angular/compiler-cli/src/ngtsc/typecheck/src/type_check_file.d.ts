...
import { TypeCheckBlockMetadata, TypeCheckingConfig } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
...
import { TcbGenericContextBehavior } from '@angular/compiler-cli/src/ngtsc/typecheck/src/type_check_block';
/**
