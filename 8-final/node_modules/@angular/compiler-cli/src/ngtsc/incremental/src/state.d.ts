...
import { FileTypeCheckingData } from '@angular/compiler-cli/src/ngtsc/typecheck/src/checker';
import { SemanticDepGraph } from '@angular/compiler-cli/src/ngtsc/incremental/semantic_graph';
