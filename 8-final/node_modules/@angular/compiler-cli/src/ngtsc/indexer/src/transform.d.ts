...
import { IndexedComponent } from '@angular/compiler-cli/src/ngtsc/indexer/src/api';
import { IndexingContext } from '@angular/compiler-cli/src/ngtsc/indexer/src/context';
/**
