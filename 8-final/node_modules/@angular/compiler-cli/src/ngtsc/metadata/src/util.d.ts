...
import { OwningModule, Reference } from '@angular/compiler-cli/src/ngtsc/imports';
import { ClassDeclaration, ReflectionHost } from '@angular/compiler-cli/src/ngtsc/reflection';
import { DirectiveMeta, DirectiveTypeCheckMeta, MetadataReader, NgModuleMeta, PipeMeta } from '@angular/compiler-cli/src/ngtsc/metadata/src/api';
import { ClassPropertyMapping } from '@angular/compiler-cli/src/ngtsc/metadata/src/property_mapping';
