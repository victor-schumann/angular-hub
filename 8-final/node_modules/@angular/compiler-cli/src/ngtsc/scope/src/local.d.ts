...
import { AliasingHost, Reference, ReferenceEmitter } from '@angular/compiler-cli/src/ngtsc/imports';
import { DirectiveMeta, MetadataReader, MetadataRegistry, NgModuleMeta, PipeMeta } from '@angular/compiler-cli/src/ngtsc/metadata';
import { ClassDeclaration } from '@angular/compiler-cli/src/ngtsc/reflection';
import { ComponentScopeReader, LocalModuleScope, RemoteScope } from '@angular/compiler-cli/src/ngtsc/scope/src/api';
import { DtsModuleScopeResolver } from '@angular/compiler-cli/src/ngtsc/scope/src/dependency';
