...
import { ImportRewriter } from '@angular/compiler-cli/src/ngtsc/imports';
import { FactoryInfo, FactoryTracker, ModuleInfo, PerFileShimGenerator } from '@angular/compiler-cli/src/ngtsc/shims/api';
/**
